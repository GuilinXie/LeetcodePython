...
|43 | [43 Multiply Strings](https://leetcode.com/problems/multiply-strings/) | [Python](https://github.com/GuilinXie/LeetcodePython/blob/master/Python/Arrary/43_Multiply_Strings.py) | Medium | find the right index after multiply |
...
|    46  |  [Permutations](https://leetcode.com/problems/permutations/) | [Python](https://github.com/GuilinXie/LeetcodePython/blob/master/Python/DFS/46_Permutations.py)| Medium |dfs  + backtracking, from itertools import permutations, time complexity < O(n^2 * n!) | 
...
| 5   | [Longest Palindromeic Substring](https://leetcode.com/problems/longest-palindromic-substring/) | [Python](https://github.com/GuilinXie/LeetcodePython/blob/master/Python/String/5_LongestPalindromicSubstring.py) | Medium | expanding |
